...
```{r, eval = T, cache = F}
rbbt::bbt_update_bib("index.qmd")
```

# Preface {.unnumbered}

This is the course website for "Angewandte Datenverarbeitung und Visualisierung" at the Humboldt-Universität zu Berlin, Institut der deutsche Sprache und Linguistik. @winter_statistics_2019
